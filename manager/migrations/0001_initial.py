# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-05-22 02:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lead', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='manager.Lead')),
            ],
            options={
                'ordering': ('name',),
            },
